angular.module('app.spinalforge.plugin')
  .factory('itemPanelFactory', ["$rootScope", "$compile", "$templateCache", "$http",
    function ($rootScope, $compile, $templateCache, $http) {
      ...
      let toload = [{
        uri: '../templates/spinal-env-viewer-annotation-group-panel/itemTemplate.html',
        name: 'itemTemplate.html'
      }];
      ...
      return {
        getPanel: () => {
          if (init == false) {
            init = true;
            $(_container).html("<div ng-controller=\"itemCtrl\" class=\"panelContent\" ng-cloak>" +
              $templateCache.get("itemTemplate.html") + "</div>");
